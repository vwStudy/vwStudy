...
>>>>>>> 3d91e37f7bf619552689fe47de32118d4b2a7d73
        ...
        for index, oneDivisionList in enumerate(GA_list):
            for twoDivisionIndex, deploy_check in enumerate(oneDivisionList):
                if 1 == deploy_check:
                    ...
                    #VWの左上, 左下, 右上, 右下を設定
<<<<<<< HEAD
                    VW_LeftUp = [(380 + (size) * twoDivisionIndex), (200 + (size * index))]
=======
...
>>>>>>> 3d91e37f7bf619552689fe47de32118d4b2a7d73
        ...
        #car1.get_visibility_graph(car1_vis_graph, car2_vis_graph, car3_vis_graph, car4_vis_graph)
...
<<<<<<< HEAD
        # car1.get_shortest_path(car1_shortest_path, car2_shortest_path, car3_shortest_path, car4_shortest_path)
=======
...
class CarAgent():
    ...
    def get_visibility_graph(self,car1_vis_graph,car2_vis_graph,car3_vis_graph,car4_vis_graph):

        self.car1_vis_graph = car1_vis_graph
        self.car2_vis_graph = car2_vis_graph
        self.car3_vis_graph = car3_vis_graph
        self.car4_vis_graph = car4_vis_graph

        list1 = [self.car1_vis_graph,self.car2_vis_graph,self.car3_vis_graph,self.car4_vis_graph]
        return list1


    #def get_shortest_path(car1_shortest_path, car2_shortest_path, car3_shortest_path, car4_shortest_path):
...
<<<<<<< HEAD
    ...
    #visibility_graph = Execution.visibility_graph
    #dijkstra = Execution.dijkstra
