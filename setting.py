...
# car3_STARTtoGOAL : float = [[640.0, 262.0],[257.0, 262.0]]
# car3_STARTtoGOAL : float = [[642.0, 250.0],[257.0, 250.0]]##右車
# car4_STARTtoGOAL : float = [[450.0, 363.0],[450.0, 147.0]]##下車
# car4_STARTtoGOAL : float = [[462.0, 363.0], [462.0, 147.0]]
car4_STARTtoGOAL : float = [[450.0, 363.0],[450.0, 147.0]]##下車
...
#最悪
# car1_STARTtoGOAL : float = [[254.0, 269.0],[615.0, 269.0]]
# car2_STARTtoGOAL : float = [[450.0, 363.0],[450.0, 147.0]]
# car3_STARTtoGOAL : float = [[615.0, 250.0],[254.0, 250.0]]
# car4_STARTtoGOAL : float = [[450.0, 147.0],[450.0, 363.0]]

#普通
# car1_STARTtoGOAL : float = [[250.0, 225.0],[642.0, 225.0]]##左車
# car2_STARTtoGOAL : float = [[475.0, 363.0],[475.0, 147.0]]##上車
# car3_STARTtoGOAL : float = [[642.0, 250.0],[250.0, 250.0]]##右車
# car4_STARTtoGOAL : float = [[450.0, 147.0],[468.0, 363.0]]##下車

#マシ
car1_STARTtoGOAL : float = [[254.0, 269.0],[630.0, 269.0]]
car2_STARTtoGOAL : float = [[450.0, 363.0],[450.0, 147.0]]
car3_STARTtoGOAL : float = [[630.0, 250.0],[254.0, 250.0]]
car4_STARTtoGOAL : float = [[450.0, 147.0],[468.0, 363.0]] 