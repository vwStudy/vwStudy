...
def main():
    ...
    solution_list = [0.2749425322547525, 0.8316100300887836, 0.7279128359405027, 0.23645083437130765, 0.43286323767247215, 0.26371793971164403, 0.4190702214669866, 0.9570443708450169, 0.3043362896702827, 1.2811425455704595, 0.28358989118861255, 0.8432205818794958, 0.09599941777336211, 0.20041597617483942, 0.37557320526350946, 0.7545175221320424]
    ...
    for i in range(len(car2_shortest_path)-1):
         ...
         print(len(car2_shortest_path)-1)
         print("car2x"+str(car2_vertex_list[car2_shortest_path[i]][0]))
         print("car2y"+str(car2_vertex_list[car2_shortest_path[i]][1]))
